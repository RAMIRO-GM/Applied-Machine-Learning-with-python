...
#trying with 3 different hidden units one single hidden layer
...
X_train, X_test, y_train, y_test = train_test_split(X_D2, y_D2, random_state=0)
#set 2  hidden_layer sizes referencing thw 10 hidden units used in each hidden layer
...
#2 hidden layers of 100 hidden units
