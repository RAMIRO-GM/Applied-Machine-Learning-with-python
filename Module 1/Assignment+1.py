...
def answer_two():
    cancerData = answer_one()
    #Get the counts of the 0's and 1's
    target = cancerData["target"].value_counts(ascending=True)
    # Add th indexes names
...
def answer_six():
    ...
    return predicter.predict(means)
